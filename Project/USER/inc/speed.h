...
extern float StraightExpectSpeed;     //直�?�期望速度
extern float TurnExpectSpeed;         //�?道期望速度
extern float SpeedUpSpeed;
extern float DownSpeed ;
extern int outPWM1, outPWM2, diffPWM; // 出车库直行速度 �? �?向偏�?
...
extern float Kspeed;  //速度和方向控制的比例系数，�?�注意控制Kspeed，不然速度�?�?控制会不平滑
